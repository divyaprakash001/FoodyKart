...
class UserManager(BaseUserManager):
  def create_user(self,first_name,last_name,username,email,password=None):
    ...
    user.set_password(password)  #encode the password and store in db
...
class UserProfile(models.Model):
  user = models.OneToOneField(User, on_delete=models.CASCADE,blank=True, null=True) #when user is deleted then its profile also will be deleted
