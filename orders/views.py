...
def payments(request):
  ...
  if request.headers.get('x-requested-with') == 'XMLHttpRequest':
    ...
    # store the oayment details in the payment model
    ...
    # move the cart item to ordered food model
     ...
     # clear the cart if the payment is success
      ...
      return JsonResponse({"status":"Order Success","message":"Order Placed",'order_number':order_number,'transaction_id':transaction_id})
    else:
      return JsonResponse({"status":"Invalid Request","message":"Request Method Not Allowed"})
  else:
    return JsonResponse({"status":"Failed","message":"Not Supported request"})
